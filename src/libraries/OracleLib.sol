 ...
 * @notice This library is used to check chainlink Oracle for stale price.
 ...
 *
 *
 * so if the chainLink network fails and you have a lot of money in the protocol... you're screwed.
 *
 */
